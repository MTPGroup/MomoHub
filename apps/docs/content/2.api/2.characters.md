...
```bash
curl -X PUT https://api.momohub.com/v1/characters/967217c8-4e26-4404-bcc4-03e084b5d6f9/avatar \
...
::endpoint{method="GET" path="/characters/{characterId}/knowledge-bases" auth}
获取指定角色订阅的所有知识库列表，需要是角色的作者。
::
